...
import  {IProps, IState, IIssue, ILang, IRepositoryTopic, IProject} from "./interfaces";
  ...
  renderLanguages(project: IProject) {
    ...
    return project.node.languages.nodes.map((language: ILang) => {
		...
		if(	language.name == "JavaScript" 
			...
			return (
				<div className="relative" style={languagePosition}>					
						{languageToSVG[language.name]}
				  <br/>
				</div>
			  );
		}
      ...
      return (
        <div>
          ...
          >
            ...
            <div className="absolute" style={languagePosition}>
              {
			  	...
			  	{project.node.stargazers.totalCount !="0" ? (
					<div>
					<div className="absolute" style={stargazersPosition}>
					...
					<div className="absolute" style={stargazersPosition}>
						<div className="relative">
							<div className="my-4 mx-5 text-xs underline subpixel-antialiased text-black">
            ...
            <div className="relative p-4 h-60 max-h-60">
              <h3 className="text-base md:text-xl font-medium text-gray-800 underline decoration-pink-500">
                {project.node.name}
              </h3>
