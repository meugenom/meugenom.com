            ...
            <ul>
              ...
              ${letters.map((letter: any) => 
                ...
                <li class="text-slate-600 font-medium hover:text-indigo-600">
                  <span class="text-[8px] font-semibold py-1 px-2 uppercase rounded text-white bg-indigo-400 uppercase last:mr-0 mr-1">
                  ${letter.letter}
                  </span>                    
                    ...
                    `
                      <a key="${tag.name}" 
                        href="${`#/tag/${tag.name}`}"
                        class="text-[8px] font-medium py-1 px-2 uppercase rounded text-white bg-slate-400  hover:bg-slate-500 uppercase last:mr-0 mr-1">                        
                        ${tag.name}
                      </a>                                              
                    `).join('')}
                </li>
